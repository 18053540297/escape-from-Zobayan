...
public class GameUtil {
    ...
    static Image lei = Toolkit.getDefaultToolkit().getImage("imgs/雷.png");//雷
    static Image top = Toolkit.getDefaultToolkit().getImage("imgs/格子.gif");//格子
    static Image flag = Toolkit.getDefaultToolkit().getImage("imgs/旗子.gif");//旗子
    static Image noflag = Toolkit.getDefaultToolkit().getImage("imgs/插错旗.png");//插错旗
    static Image face = Toolkit.getDefaultToolkit().getImage("imgs/游戏中.png");//游戏中
    static Image over = Toolkit.getDefaultToolkit().getImage("imgs/失败.png");//失败
    static Image win = Toolkit.getDefaultToolkit().getImage("imgs/胜利.png");//胜利
